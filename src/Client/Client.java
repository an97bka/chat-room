...
//---------[ Socket ]-----------//	
	private void go() {
		try {
			...
			JOptionPane.showMessageDialog(this, "Lỗi kết nối, xem lại dây mạng đi hoặc room chưa mở.", "Message Dialog",
